...
//CODE HERE
const greetingsPerson = name => {
  console.log('Hello ' + name);
};

greetingsPerson('Derek');
...
//CODE HERE
const upperify = string => {
  console.log(string.toUpperCase());
};

upperify(sampleString);
////////////////// PROBLEM 18 ////////////////////
/*
...
console.log(emailCheck('  derekbal@gmailcom'));
...
//CODE HERE
const howManyChocoFrogs = willingSpendings => {
  let chocoFrogPrice = 3;
  return willingSpendings / 3;
};

console.log(howManyChocoFrogs(10));
...
//CODE HERE
const howManyChocoFrogs2 = willingSpendings => {
  let chocoFrogPrice = 3;
  return Math.floor(willingSpendings / 3);
};

console.log(howManyChocoFrogs2(10));
